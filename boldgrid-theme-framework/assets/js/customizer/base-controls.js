...
( function( $ ) {
	 ...
	 */
	wp.customize.controlConstructor['kirki-typography'] = wp.customize.controlConstructor['kirki-typography'].extend( bgtfwTypography );
	wp.customize.controlConstructor['bgtfw-menu-hamburgers'] = wp.customize.Control.extend( bgtfwMenuHamburgers );
	wp.customize.controlConstructor['bgtfw-sortable-accordion'] = wp.customize.Control.extend( bgtfwSortableAccordion );
