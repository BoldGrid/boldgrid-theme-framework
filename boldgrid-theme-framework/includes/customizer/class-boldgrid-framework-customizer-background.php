...
class Boldgrid_Framework_Customizer_Background {
	...
	public function create_background_styles() {
		$bg_pattern_default = 'none';
		if ( ! empty( $background_options['defaults']['boldgrid_background_pattern'] ) ) {
			$bg_pattern_default = self::get_default_pattern_mod( $this->configs );
		}
		...
		$bg_pattern = get_theme_mod( 'boldgrid_background_pattern', $bg_pattern_default ) ? get_theme_mod( 'boldgrid_background_pattern', $bg_pattern_default ) : 'none';
