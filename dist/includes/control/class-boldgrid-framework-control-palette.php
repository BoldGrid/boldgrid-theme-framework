...
<div class='boldgrid-color-palette-wrapper color-palette-columns-<?php echo $color_palettes['color-palette-size'];?>'
		...
		<ul class='boldgrid-inactive-palette' 
		 ...
		 >
		    <li class='boldgrid-palette-colors'>
				<?php foreach ( $color_palette['colors'] as $key => $color ): ?>
			    	<span 
	...
	<?php endforeach; ?>
		...
		<div class="boldgrid-neutral-color">Neutral Color</div>
