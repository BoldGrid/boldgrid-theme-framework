...
return array(
	...
	'buttons' => array(
		...
		'general' => array(
			...
			array(
				'control' => 'bgtfw_site_title',
				'selector' => '.bgc_site_title',
				'isParentColumn' => true,
				'requireText' => true,
				'objectType' => 'section',
				'title' => esc_attr__( 'Site Title', 'bgtfw' ),
			...
			array(
				'control' => 'bgtfw_tagline',
				'selector' => '.bgc_site_description',
				'isParentColumn' => true,
				'requireText' => true,
				'objectType' => 'section',
			...
			array(
				'control' => 'headings_typography',
				'selector' => '.bgc_page_title',
				'isParentColumn' => true,
				'requireText' => true,
				'objectType' => 'section',
				'title' => esc_attr__( 'Headings', 'bgtfw' ),
			),
			array(
				'control' => 'custom_logo',
				'selector' => '#masthead .custom-logo, bgc_header_logo',
				'isParentColumn' => true,
