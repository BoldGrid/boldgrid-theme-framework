...
return array(
	...
	'bgtfw_body_typography'            => array(
		...
		'output'    => $bgtfw_typography->get_typography_output(
			$bgtfw_configs,
			'.widget, .site-content, .sm li.custom-sub-menu a, .sm li.custom-sub-menu .widget a, .attribution-theme-mods-wrapper, .gutenberg .edit-post-visual-editor, .mce-content-body, .template-header, .template-footer'
		),
		'edit_vars' => array(
			array(
				'selector'    => array(
