...
return array(
	...
	'options' => array(
		...
		'goup' => array(
			...
			'locationOffset'   => '30px', // Pixels from the button is distant from the edge of the screen, based on set location..
			'bottomOffset'     => '30px', // Pixels from the bottom edge of screen.
			'containerSize'    => '40px', // The width and height of the button (minimum is 20).
			...
			'trigger'          => '500px', // After how many scrolled down pixels the button must be shown (bypassed by alwaysVisible).
			...
			'hideUnderWidth'   => '500px', // The threshold of window width under which the button is permanently hidden.
